...
contract CatToken is Context, IERC20, Ownable {
    ...
    string private _name = "Star Wars Cat";
    string private _symbol = "SWCAT";
    ...
    uint256 public _managementFee = 5;
    ...
    uint256 private numTokensSellToAddToLiquidity = 50 * 10**8 * 10**9;
    ...
    constructor (address _swapAddr) {
        _rOwned[_msgSender()] = _rTotal;
        // _swapAddr = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(_swapAddr);
    ...
    function setFeeMgr(address _feeMgr) external onlyOwner() {
        feeMgr = _feeMgr;
    }
